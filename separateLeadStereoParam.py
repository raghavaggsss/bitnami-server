...
def main(inputAudioFile,song_name,to_email_id):
    #BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    #inputAudioFile = os.path.join(BASE_DIR, 'media/songs/' + inputAudioFile)
    import optparse
    ...
    BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    input_Audio_path = os.path.join(BASE_DIR, 'Project/media/songs/')
    os.chdir(input_Audio_path)
    ...
    outputFileName = os.path.join(BASE_DIR,'Project/media/karaoke/' + to_email_id + song_name)
